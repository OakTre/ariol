		...
		ScrollTrigger.matchMedia({
			"(min-width: 767px)": function () {
				...
				let tl22 = gsap.timeline({
					scrollTrigger: {
						trigger: ".js-about-company-info-block2",
						start: "top bottom",
						end: "top 60%",
						scrub: true,
						scrub: 5,
				...
				tl22.to(".js-about-company-info-block2", {
					x: 0
				})
